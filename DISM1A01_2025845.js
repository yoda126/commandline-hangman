...
function choosetheme() {
    ...
    if (themenum == 1) {
        themedefin = "CA2\\Words_definition\\clothingdefinitions.txt";
        return "CA2\\Words\\clothing.txt";
    }
    else if (themenum == 2) {
        themedefin = "CA2\\Words_definition\\weaponsdefinitions.txt";
        return "CA2\\Words\\weapons.txt";
    }
    else if (themenum == 3) {
        themedefin = "CA2\\Words_definition\\periodic_tabledefinitions.txt";
        return "CA2\\Words\\periodic_table.txt";
    }
    else {
...
var filename = "CA2\\player_data\\" + game.playername + "data.txt";
